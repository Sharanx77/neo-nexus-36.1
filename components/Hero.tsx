  ...
  return (
    <section id="home" className="relative pt-28 pb-20 lg:pt-40 lg:pb-32 px-4 flex justify-center items-center flex-col z-10">
      ...
      <div className="text-center max-w-6xl mx-auto w-full">
        {/* Adaptive Subhead */}
        <span className="text-electric font-bold tracking-[0.2em] text-xs sm:text-sm md:text-base lg:text-lg uppercase mb-4 sm:mb-5 block animate-pulse">
        ...
        <div className="flex flex-col sm:flex-row flex-wrap justify-center gap-3 sm:gap-4 mb-10">
          <div className="bg-[#030811]/70 backdrop-blur-md px-6 sm:px-8 py-3 sm:py-4 rounded-full border border-electric/50 shadow-[0_0_15px_rgba(14,124,196,0.2)]">
            <span className="font-extrabold text-sm sm:text-base tracking-widest text-electric uppercase">8th & 9th August 2026</span>
          </div>
          <div className="bg-[#030811]/70 backdrop-blur-md px-6 sm:px-8 py-3 sm:py-4 rounded-full border border-cyan/50 shadow-[0_0_15px_rgba(6,182,212,0.2)]">
