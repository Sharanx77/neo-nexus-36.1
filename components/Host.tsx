      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="bg-[#030811]/60 backdrop-blur-md p-10 md:p-16 rounded-3xl border border-electric/30 shadow-[0_0_25px_rgba(14,124,196,0.1)] flex flex-col md:flex-row items-center gap-10">
          ...
          <div className="w-full md:w-1/3 flex flex-col items-center">
            <div className="w-48 h-48 bg-white rounded-full flex items-center justify-center border-4 border-electric shadow-[0_0_25px_rgba(14,124,196,0.3)] mb-6 overflow-hidden z-10 relative">
              <img src="/logo/bitm.png" alt="BITM Logo" className="w-full h-full object-contain p-4" />
            </div>

            <div className="flex gap-4 w-full justify-center max-w-[400px]">
              {campusPhotos.map((photo, i) => (
                <div 
                  key={i}
                  onClick={() => setIndex(i)}
                  className="w-1/2 aspect-[4/3] rounded-xl overflow-hidden border border-white/20 shadow-lg group relative cursor-pointer"
                >
          ...
          <div className="w-full md:w-2/3">
            ...
            <div className="grid grid-cols-2 gap-4 text-base mt-6">
              ...
              <div className="bg-[#030811]/40 p-4 rounded-xl border border-white/10 shadow-[0_0_10px_rgba(255,255,255,0.02)]">
                ...
                <span className="text-white font-bold">VTU</span>
              </div>
              <div className="bg-[#030811]/40 p-4 rounded-xl border border-white/10 shadow-[0_0_10px_rgba(255,255,255,0.02)]">
