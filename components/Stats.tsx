  ...
  return (
    <div className="max-w-7xl mx-auto px-4 mb-16 md:mb-24 relative z-10">
      <div className="bg-[#030811]/75 backdrop-blur-lg py-6 px-4 md:px-6 lg:px-8 rounded-2xl border border-electric/40 shadow-[0_0_30px_rgba(14,124,196,0.25)] relative overflow-hidden">
        ...
        <div className="flex flex-wrap justify-center items-center gap-3 sm:gap-4 md:gap-5 w-full text-center text-gray-200 font-bold text-xs sm:text-sm lg:text-base tracking-widest uppercase">
          
          <span className="whitespace-nowrap">6 Domains</span>
          
          <span className="text-cyan/50 drop-shadow-[0_0_5px_rgba(6,182,212,0.8)]">✦</span>
          
          <span className="whitespace-nowrap">36 Hours</span>
          
          <span className="text-cyan/50 drop-shadow-[0_0_5px_rgba(6,182,212,0.8)]">✦</span>
          
          <span className="whitespace-nowrap text-gold font-black text-sm md:text-xl drop-shadow-[0_0_10px_rgba(234,179,8,0.4)]">
            Prize Pool: 1 Lakh+
          </span>
