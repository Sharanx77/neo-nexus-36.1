export default function Timeline() {
  const schedule = [
    ...
    { phase: 'Phase 2', date: '10th August -- 13th August 2026', title: 'Abstract Shortlisting', desc: 'Abstracts reviewed; shortlisted teams notified by email.', glow: 'hover:border-cyan/50 hover:shadow-[0_0_25px_rgba(6,182,212,0.3)]', bar: 'bg-cyan', textCol: 'text-cyan' },
