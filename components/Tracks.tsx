    ...
    <section id="tracks" className="py-12 sm:py-16 relative z-10">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-10 sm:mb-16">
          ...
          <p className="text-gray-300 text-base sm:text-lg max-w-3xl mx-auto font-normal px-2">Each team must select exactly one domain track at registration (no changes after abstract deadline).</p>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8">
          {tracks.map((track) => (
            <div key={track.id} className="bg-[#030811]/60 backdrop-blur-md p-6 sm:p-8 rounded-3xl border border-white/10 hover:border-cyan/50 shadow-[0_0_15px_rgba(255,255,255,0.05)] hover:shadow-[0_0_30px_rgba(6,182,212,0.25)] transition-all duration-500 group cursor-pointer flex flex-col h-full relative overflow-hidden">
              ...
              <div className="text-cyan font-black text-xs sm:text-sm tracking-widest bg-cyan/10 border border-cyan/30 shadow-[0_0_10px_rgba(6,182,212,0.2)] px-3 sm:px-4 py-1 sm:py-1.5 rounded-full inline-block w-max mb-4 sm:mb-6 relative z-10">
                [{track.id}]
              </div>
              
              <h3 className="text-xl sm:text-2xl font-bold mb-2 sm:mb-3 font-heading tracking-wide text-white group-hover:text-transparent group-hover:bg-clip-text group-hover:bg-gradient-to-r group-hover:from-white group-hover:to-cyan transition-all relative z-10">
                {track.title}
              </h3>
